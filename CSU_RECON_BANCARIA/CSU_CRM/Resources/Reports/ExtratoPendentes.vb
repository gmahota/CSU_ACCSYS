...
Public Class ExtratoPendentes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CSU_CRM_Dll.ExtratoPendentes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Entidade() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedExtratoPendentes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExtratoPendentes = New ExtratoPendentes()
        rpt.Site = Me.Site
        Return rpt
    End Function
